...
#' \itemize{
#' \item `charset` - a vector of character strings with the characters present in the font
#' \item `png` - a matrix of 0's and 1's grabbed from the PNG file for the font using the package
#'   [imager](https://cran.r-project.org/package=imager).
#' }
#'
#' @keywords datasets
#'
#' @source <http://uzebox.org/wiki/index.php?title=Font_Bitmaps>
#'
#' @examples
#' data(font_sets)
"font_sets"
